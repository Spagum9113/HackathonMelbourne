...
export default function StartupListing15() {
    return (
        <div className="bg-[url('/bg1.png')] bg-cover bg-[position:50%_30%] min-h-screen text-white">
            ...
            <section className="flex flex-col items-center text-center mt-16 pt-16 sm:pt-32">
                <h2 className="text-4xl font-bold mx-5">Unconventional Startups: Launching a Startup and Investing in Sextech
                </h2>
                <p className="text-gray-400 mt-5 mx-5 max-w-2xl">
                    Explore taboo-breaking innovation and investment opportunities in Sextech.
            ...
            <section className="flex justify-center pt-16 sm:pt-36 pb-5">
                ...
                <div className="flex flex-col md:flex-row gap-6 max-w-4xl w-full">
                    ...
                    <div className=" relative border-2 rounded-xl items-center overflow-hidden mx-5 sm:mx-auto max-w-lg sm:max-w-xs space-y-4 p-4">
                        ...
                        <a href="https://events.humanitix.com/unconventional-startups-launching-and-investing-in-sextech?hxchl=mkt-sch&_gl=1*zaurs9*_gcl_au*NjQ4NjMzMDUwLjE3MzY5NjcwNDQ.*_ga*ODA0OTc5NTk0LjE3MzY5NjcwNDQ.*_ga_LHKW5FR9N6*MTc0MjQ4MjczNi4zMy4xLjE3NDI0ODI3OTMuMy4wLjA" target="_blank" rel="noopener noreferrer">
            ...
            <section className="border-2 border-white rounded-xl max-w-4xl sm:mx-auto p-5 -mb-20 sm:mb-96 mx-5">
                <div className="">
                    ...
                    <p className="text-gray-200 pb-2">
                        Join us on May 22nd, 2025, at Collingwood Yards for an unconventional afternoon and evening exploring the Sextech industry. Hear from thought leaders, founders, and investors shaping this space. The event will include panels, networking, and a pitch event focused on innovation, ethics, and investment in the sextech and wellness industries.
