...
export default function StartupListing13() {
    return (
        <div className="bg-[url('/bg1.png')] bg-cover bg-[position:50%_30%] min-h-screen text-white">
            ...
            <section className="flex flex-col items-center text-center mt-16 pt-16 sm:pt-32">
                <h2 className="text-4xl font-bold mx-5">ClimateTech & AgTech Pitch Night
                </h2>
                <p className="text-gray-400 mt-5 mx-5 max-w-2xl">
                    Celebrating bold innovation in sustainability and agriculture.
            ...
            <section className="flex justify-center pt-16 sm:pt-36 pb-5">
                ...
                <div className="flex flex-col md:flex-row gap-6 max-w-4xl w-full">
                    ...
                    <div className=" relative border-2 rounded-xl items-center overflow-hidden mx-5 sm:mx-auto max-w-lg sm:max-w-xs space-y-4 p-4">
                        ...
                        <a href="https://www.eventbrite.com.au/e/climatetech-agtech-pitch-night-tickets-1088682250919?aff=ebdssbdestsearch" target="_blank" rel="noopener noreferrer">
            ...
            <section className="border-2 border-white rounded-xl max-w-4xl sm:mx-auto p-5 -mb-20 sm:mb-96 mx-5">
                <div className="">
                    ...
                    <p className="text-gray-200 pb-2">
                        Join us on April 29th at The Commons Gipps Street for The Startup Network’s ClimateTech & AgTech Pitch Night! Watch early-stage founders pitch groundbreaking solutions for climate and agricultural challenges and connect with leaders in sustainability, investment, and technology.
